...
export class CreateUser1686138580147 implements MigrationInterface {
    name = 'CreateUser1686138580147'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announcement" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying(250) NOT NULL, "model" character varying(250) NOT NULL, "year" character varying(4) NOT NULL, "fuel" integer NOT NULL, "mileage" integer NOT NULL, "color" character varying(50) NOT NULL, "price_table_fipe" character varying NOT NULL, "price" character varying NOT NULL, "description" character varying(300) NOT NULL, "published" boolean NOT NULL DEFAULT true, "createdAt" date NOT NULL DEFAULT now(), "deletedAt" date, "userId" uuid, CONSTRAINT "UQ_e5d37fed5810bf329708260287b" UNIQUE ("brand"), CONSTRAINT "PK_e0ef0550174fd1099a308fd18a0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "cpf" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "telephone" character varying(11) NOT NULL, "date_of_birth" date NOT NULL, "description" character varying(300), "buyer" boolean NOT NULL DEFAULT true, "createdAt" date NOT NULL DEFAULT now(), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
